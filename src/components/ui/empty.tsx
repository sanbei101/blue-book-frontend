...
function Empty({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="empty"
      className={cn(
        "flex min-w-0 flex-1 flex-col items-center justify-center gap-4 rounded-lg border-dashed px-6 py-12 text-center",
        className,
      )}
      {...props}
    />
...
const emptyMediaVariants = cva("flex shrink-0 items-center justify-center", {
  variants: {
    variant: {
      ...
      icon: "bg-muted text-foreground flex size-10 items-center justify-center rounded-lg [&_svg]:size-5",
    },
  },
  defaultVariants: {
    variant: "default",
